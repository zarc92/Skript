...
public class DefaultFunctions {
	...
	static {
		...
		Functions.registerFunction(new JavaFunction<Number>("mod", new Parameter[] {new Parameter<>("d", numberClass,
				true, null), new Parameter<>("m", numberClass, true, null)}, numberClass, true) {
		...
		Functions.registerFunction(new JavaFunction<Number>("log", new Parameter[] {new Parameter<>("n", numberClass,
				true, null), new Parameter<>("base", numberClass, true, new SimpleLiteral<Number>(10, false))},
				numberClass, true) {
		...
		Functions.registerFunction(new JavaFunction<Number>("atan2", new Parameter[] {new Parameter<>("x", numberClass,
				true, null), new Parameter<>("y", numberClass, true, null)}, numberClass, true) {
		...
		Functions.registerFunction(new JavaFunction<World>("world",
				new Parameter[] {new Parameter<>("name", Classes.getExactClassInfo(String.class), true, null)},
				Classes.getExactClassInfo(World.class), true) {
		...
		Functions.registerFunction(new JavaFunction<Location>("location",
				new Parameter[] {new Parameter<>("x", numberClass, true, null), new Parameter<>("y", numberClass, true,
						null), new Parameter<>("z", numberClass, true, null), new Parameter<>("world",
								Classes.getExactClassInfo(World.class), true,
								new EventValueExpression<>(World.class)), new Parameter<>("yaw", numberClass, true,
										new SimpleLiteral<Number>(0, true)), new Parameter<>("pitch", numberClass, true,
												new SimpleLiteral<Number>(0, true))},
				Classes.getExactClassInfo(Location.class), true) {

			@Override
			public Location[] execute(final FunctionEvent e, final Object[][] params) {
				return new Location[] {new Location((World) params[3][0], ((Number) params[0][0]).doubleValue(),
						((Number) params[1][0]).doubleValue(), ((Number) params[2][0]).doubleValue(),
		...
		Functions.registerFunction(new JavaFunction<Date>("date",
				new Parameter[] {new Parameter<>("year", numberClass, true, null), new Parameter<>("month", numberClass,
						true, null), new Parameter<>("day", numberClass, true, null), new Parameter<>("hour",
								numberClass, true, new SimpleLiteral<Number>(0, true)), new Parameter<>("minute",
										numberClass, true, new SimpleLiteral<Number>(0, true)), new Parameter<>(
												"second", numberClass, true,
												new SimpleLiteral<Number>(0, true)), new Parameter<>("millisecond",
														numberClass, true,
														new SimpleLiteral<Number>(0, true)), new Parameter<>(
																"zone_offset", numberClass, true,
																new SimpleLiteral<Number>(Double.NaN,
																		true)), new Parameter<>("dst_offset",
																				numberClass, true,
																				new SimpleLiteral<Number>(Double.NaN,
																						true)),},
		...
		Functions.registerFunction(new JavaFunction<Vector>("vector",
				new Parameter[] {new Parameter<>("x", numberClass, true, null), new Parameter<>("y", numberClass, true,
						null), new Parameter<>("z", numberClass, true, null)},
				Classes.getExactClassInfo(Vector.class), true) {

			@Override
			@Nullable
			public Vector[] execute(FunctionEvent e, Object[][] params) {
				return new Vector[] {new Vector(((Number) params[0][0]).doubleValue(),
						((Number) params[1][0]).doubleValue(), ((Number) params[2][0]).doubleValue())};
			}
		...
		Functions.registerFunction(new JavaFunction<Long>("calcExperience",
				new Parameter[] {new Parameter<>("level", longClass, true, null)}, longClass, true) {
		...
		}.description("Calculates experience needed to achieve given level in Minecraft.").since("2.2-dev32"));
