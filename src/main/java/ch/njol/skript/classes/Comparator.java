...
public interface Comparator<T1, T2> {
	...
	enum Relation {
		...
		/**
		 * Test whether this relation is fulfilled if another is, i.e. if the parameter relation fulfils
		 * <code>X rel Y</code>, then this relation fulfils <code>X rel Y</code> as
		 * well.
		 * 
		 * @param other
