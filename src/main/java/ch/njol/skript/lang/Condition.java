...
public abstract class Condition extends Statement {
	 ...
	 * any way, as conditions are only checked until one returns
	...
	/**
	 * Sets the negation state of this condition. This will change the behaviour of
	 * {@link Expression#check(Event, Checker, boolean)}.
	 * 
	 * @param invert
	 */
