...
//			Skript.error("No economy plugin detected");
		...
		final String singular = VaultHook.economy.currencyNameSingular(),
				plural = VaultHook.economy.currencyNamePlural();
		if (!plural.isEmpty()) {
